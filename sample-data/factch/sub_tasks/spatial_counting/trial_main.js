function trialMain_counting_spatial(params, bloc_params) {
    ...
    let timeline = [
        ...
        // First spatial cue
        {
            ...
            choices: [],
            trial_duration: bloc_params.t_spc,
            post_trial_gap: bloc_params.t_isi - bloc_params.t_spc,
        },
        ...
        // Response
        {
            ...
            choices: params.buttons_counting,
            ...
            data: {
                ...
                trial_response: true,
                dim_x: jsPsych.timelineVariable('dim_x_spc'),
                dim_y: jsPsych.timelineVariable('dim_y_spc'),
                ...
                response_mapping_0: params.response_mapping_counting[0],
                response_mapping_1: params.response_mapping_counting[1],
                response_mapping_2: params.response_mapping_counting[2],
            ...
            on_finish: function(data) {
                ...
                data.response_category = params.response_mapping_counting[data.response]
        ...
        // Feedback
        {
            ...
            button_html: function() {
                ...
                if (last_trial_feedback == 'False') {
                    for (const [i, choice] of params.buttons_counting.entries()) {
...
function trialMains_counting_spatial(params, bloc_params) {
    let bloc = {
        timeline: trialMain_counting_spatial(params, bloc_params),
