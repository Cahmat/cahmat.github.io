function buildBloc_training_generalization_spatial_instructions(params, bloc_params) {
	return build_blocInstructions_spatial(params, bloc_params)
}

function buildBloc_training_generalization_spatial(params, bloc_params) {
	return build_blocMain_spatial(params, bloc_params)
}

function buildBlocParams_training_generalization_spatial_instructions(params, bloc_params) {
	bloc_params.instructions = `<p align='left'>
			                    ...
			                    <br>
			                    <b> Your task is to identify the aliens on the planet by looking at the sequences of spatial locations that they produce.</b><br> 
                                <b> However, on some trials, there will be "perturbations". The sequences of spatial locations will be corrupted, sometimes greatly. <br> 
			                    <br>
...
function buildBlocParams_training_generalization_spatial(params, bloc_params) {
	...
	bloc_params.instructions = `<p align='left'> 
                                ...
                                <b>However, on some trials, there will be "perturbations". The sequences of spatial locations will be corrupted, sometimes greatly. <br> 
                                During the perturbation trials, the task will remain the same: you have to identify the alien that is producing the sequence. </b><br>
	                            <br>
