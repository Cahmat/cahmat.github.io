function buildBloc_training_spatial_instructions(params, bloc_params) {
	return build_blocInstructions_spatial(params, bloc_params)
}

function buildBloc_training_spatial(params, bloc_params) {
	return build_blocMain_spatial(params, bloc_params)
}

function buildBlocParams_training_spatial_instructions(params, bloc_params) {
...
function buildBlocParams_training_spatial(params, bloc_params) {
