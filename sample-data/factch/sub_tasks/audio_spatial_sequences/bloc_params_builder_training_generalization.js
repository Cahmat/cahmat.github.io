function buildBloc_training_generalization_audio_spatial_instructions(params, bloc_params) {
	return build_blocInstructions_audio_spatial(params, bloc_params)
}

function buildBloc_training_generalization_audio_spatial(params, bloc_params) {
	return build_blocMain_audio_spatial(params, bloc_params)
}

function buildBlocParams_training_generalization_audio_spatial_instructions(params, bloc_params) {
...
function buildBlocParams_training_generalization_audio_spatial(params, bloc_params) {
	...
	bloc_params.instructions = `<p align='left'> 
                                ...
                                <b>However, on some trials, there will be "perturbations". The sequences of sounds will be corrupted, sometimes greatly. <br> 
                                During the perturbation trials, the task will remain the same: you have to identify which creature is talking. </b><br>
	                            <br>
