function trialMain_unique_visual_space_mapping(params, bloc_params) {
    let timeline = [
        // Preload stimuli
        {
            type: jsPsychPreload,
        ...
        // Response
        {
            ...
            prompt: `<p style="position:absolute; text-align:center; top:21%; left:39%"> Which star position corresponds to the image?</p>`,
...
function trialMains_unique_visual_space_mapping(params, bloc_params) {
    let bloc = {
        timeline: trialMain_unique_visual_space_mapping(params, bloc_params),
