function buildBloc_training_generalization_visual_instructions(params, bloc_params) {
	return build_blocInstructions_visual(params, bloc_params)
}

function buildBloc_training_generalization_visual(params, bloc_params) {
	return build_blocMain_visual(params, bloc_params)
}

function buildBlocParams_training_generalization_visual_instructions(params, bloc_params) {
...
function buildBlocParams_training_generalization_visual(params, bloc_params) {
