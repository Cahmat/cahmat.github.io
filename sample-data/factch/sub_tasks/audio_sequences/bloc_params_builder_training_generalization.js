function buildBloc_training_generalization_audio_instructions(params, bloc_params) {
	return build_blocInstructions_audio(params, bloc_params)
}

function buildBloc_training_generalization_audio(params, bloc_params) {
	return build_blocMain_audio(params, bloc_params)
}

function buildBlocParams_training_generalization_audio_instructions(params, bloc_params) {
	bloc_params.instructions = `<p align='left'>
			                    ...
			                    <br>
			                    <b> Your task is to identify the aliens on the planet by listening to the sequences of sounds that they produce.</b><br> 
                                <b> However, on some trials, there will be "perturbations". The sequences of sounds will be corrupted, sometimes greatly. <br> 
			                    <br>
...
function buildBlocParams_training_generalization_audio(params, bloc_params) {
