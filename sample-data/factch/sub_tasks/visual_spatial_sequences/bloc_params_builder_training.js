function buildBloc_training_visual_spatial_instructions(params, bloc_params) {
	return build_blocInstructions_visual_spatial(params, bloc_params)
}

function buildBloc_training_visual_spatial(params, bloc_params) {
	return build_blocMain_visual_spatial(params, bloc_params)
}

function buildBlocParams_training_visual_spatial_instructions(params, bloc_params) {
...
function buildBlocParams_training_visual_spatial(params, bloc_params) {
	...
	bloc_params.instructions = `<p align='left'> 
	                            <b>INSTRUCTIONS</b><br>
	                            On this planet, there are 3 types of alien. You will looking at sequences of 4 images produced by the aliens. <br>
