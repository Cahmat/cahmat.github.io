function trialMain_visual_spatial(params, bloc_params) {
    let timeline = [
        // Preload stimuli
        {
            type: jsPsychPreload,
        ...
        // First image
        {
            type: jsPsychImageKeyboardResponse,
            response_ends_trial: false,
            stimulus: jsPsych.timelineVariable('img_name_0'),
            choices: [],
            trial_duration: bloc_params.t_img,
            post_trial_gap: bloc_params.t_isi - bloc_params.t_img,
        },
        ...
        // Second image
        {
            type: jsPsychImageKeyboardResponse,
            response_ends_trial: false,
            stimulus: jsPsych.timelineVariable('img_name_1'),
            choices: [],
            trial_duration: bloc_params.t_img,
            post_trial_gap: bloc_params.t_isi - bloc_params.t_img,
        },
        ...
        // Third image
        {
            type: jsPsychImageKeyboardResponse,
            response_ends_trial: false,
            stimulus: jsPsych.timelineVariable('img_name_2'),
            choices: [],
            trial_duration: bloc_params.t_img,
            post_trial_gap: bloc_params.t_isi - bloc_params.t_img,
        },
        ...
        // Fourth image
        {
            type: jsPsychImageKeyboardResponse,
            response_ends_trial: false,
            stimulus: jsPsych.timelineVariable('img_name_3'),
            choices: [],
            trial_duration: bloc_params.t_img,
            post_trial_gap: bloc_params.t_isi - bloc_params.t_img,
        },
        ...
        // Response
        {
            ...
            data: {
                ...
                trial_response: true,
                dim_x: jsPsych.timelineVariable('dim_x_img'),
                dim_y: jsPsych.timelineVariable('dim_y_img'),
                ...
                spc_before_img: jsPsych.timelineVariable('spc_before_img'),
...
function trialMains_visual_spatial(params, bloc_params) {
    let bloc = {
        timeline: trialMain_visual_spatial(params, bloc_params),
