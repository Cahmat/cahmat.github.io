function buildBloc_unique_sound_space_mapping_instructions(params, bloc_params) {
	return build_blocInstructions_unique_sound_space_mapping(params, bloc_params)
}

function buildBloc_unique_sound_space_mapping(params, bloc_params) {
	return build_blocMain_unique_sound_space_mapping(params, bloc_params)
}

function buildBlocParams_unique_sound_space_mapping_instructions(params, bloc_params) {
	bloc_params.instructions = `<p align='left'>
			                    ...
			                    <br>
			                    <b> Your task will be to associate each alien sound with a spatial location on the screen. </b><br>
			                    <br>
...
function buildBlocParams_unique_sound_space_mapping(params, bloc_params) {
	...
	bloc_params.instructions = `<p align='left'> 
	                            <b>INSTRUCTIONS</b><br>
	                            On this bloc, you will have to associate each alien sound with a spatial location. <br>
	                            On each trial, you will <b> hear a sound </b> and then you will then have to <b> click on a spatial location </b>.<br>
	                            ...
	                            <br>
	                            <b>The mapping between the alien sounds and the spatial locations is 100% deterministic.</b><br>
...
function buildBlocParams_unique_sound_space_mapping_x(params, bloc_params) {

	// Almost everything is the same as in buildBlocParams_unique_sound_space_mapping
	params,
	bloc_params = buildBlocParams_unique_sound_space_mapping(params, bloc_params)
...
function buildBlocParams_unique_sound_space_mapping_y(params, bloc_params) {
