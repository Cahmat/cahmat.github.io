function buildBloc_training_generalization_audio_visual_instructions(params, bloc_params) {
	return build_blocInstructions_audio_visual(params, bloc_params)
}

function buildBloc_training_generalization_audio_visual(params, bloc_params) {
	return build_blocMain_audio_visual(params, bloc_params)
}

function buildBlocParams_training_generalization_audio_visual_instructions(params, bloc_params) {
...
function buildBlocParams_training_generalization_audio_visual(params, bloc_params) {
