function trialMain_audio_visual(params, bloc_params) {
    let timeline = [
        // Preload stimuli
        {
            type: jsPsychPreload,
        ...
        // First visual cue
        {
            ...
            choices: [],
            trial_duration: jsPsych.timelineVariable('t_img'),
            post_trial_gap: jsPsych.timelineVariable('t_img_gap'),
        },
        ...
        // Response
        {
            ...
            data: {
                ...
                img_before_snd: jsPsych.timelineVariable('img_before_snd'),
...
function trialMains_audio_visual(params, bloc_params) {
    let bloc = {
        timeline: trialMain_audio_visual(params, bloc_params),
